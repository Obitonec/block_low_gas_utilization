...
var handleBlock = function (blockEvent) { return __awaiter(void 0, void 0, void 0, function () {
    var findings, limit, used, percent;
    return __generator(this, function (_a) {
        findings = [];
        limit = parseInt(blockEvent.block.gasLimit, 16);
        used = parseInt(blockEvent.block.gasUsed, 16);
